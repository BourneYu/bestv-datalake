...
package com.bestv.datalake.avro
...
import com.bestv.datalake.avro.DefaultSource.{AvroSchema, IgnoreFilesWithoutExtensionProperty, SerializableConfiguration}
...
private[datalake] class DefaultSource extends FileFormat with DataSourceRegister {
...
private[datalake] object DefaultSource {
  ...
  class SerializableConfiguration(@transient var value: Configuration)
    ...
    @transient private[datalake] lazy val log = LoggerFactory.getLogger(getClass)
