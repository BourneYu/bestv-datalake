...
import org.apache.spark.sql.execution.datasources.gbkjson.JacksonUtils.nextUntil
...
private[gbkjson] class SparkSQLJsonProcessingException(msg: String) extends RuntimeException(msg)
