...
package org.apache.spark.sql.execution.datasources.gbkjson
...
class DefaultSource extends TextBasedFileFormat with DataSourceRegister {
  ...
  override def shortName(): String = "gbkJson"
  ...
  override def prepareWrite(
    ...
    new OutputWriterFactory {
      override def newInstance(
        ...
        new GbkJsonOutputWriter(path, parsedOptions, bucketId, dataSchema, context)
      }
    }
  }
  ...
  override def buildReader(
    ...
    (file: PartitionedFile) => {
      ...
      val lines = linesReader.map(line=>new String(line.getBytes(), 0, line.getLength(), "GBK"))//GBK转UTF-8
  ...
  override def toString: String = "GBKJSON"
...
private[gbkjson] class GbkJsonOutputWriter(
    path: String,
    options: JSONOptions,
    bucketId: Option[Int],
    dataSchema: StructType,
